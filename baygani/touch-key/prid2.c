...
int f1,f2,f3;
ulong fingerCounter1 = 0, fingerCounter2 = 0 ,fingerCounter3 = 0;

uint touch1 ,touch2 ;
ulong  alltouch1=0 ,alltouch2=0 ,alltouch3=0;
ulong touchThreshold1=0, touchThreshold2=0 , touchThreshold3=0;
...
void main()
{
	...
	{ 	
		...
		_tkst=0;
 		...
 		if(touch1>alltouch1+15  || touch1<alltouch1-15 )alltouch1=touch1;
 		if(touch2>alltouch2+15  || touch2<alltouch2-15 )alltouch2=touch2;
 		//alltouch=touch;
