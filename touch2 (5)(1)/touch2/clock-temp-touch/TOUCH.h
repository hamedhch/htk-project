...
//Module 0
#define DataTouch_1H _tkm116dh
#define DataTouch_1L _tkm116dl
#define DataTouch1 ((_tkm116dh <<8) | _tkm116dl)
...
#define Ref1Touch()	_tkm1rol = 200; _tkm1roh = 0; //Module 0

//• TKMnC0 Register
//Multi-frequency function control
#define MFC1Touch(x) _m1dfen = x; // Disable:0 OR Enabled:1 Module 0

//Touch key module n C-to-F oscillator frequency hopping function control select
#define CtF1Touch(x) _m1sofc = x; // Controlled by MnSOF2~MnSOF0:0 OR Controlled by hardware circuit:1 Module 0
...
#define	SCtf1Touch() _m1sof2 = 1; _m1sof1= 1; _m1sof0 = 1

//• TKMnC1 Register
//Touch key module n time slot counter clock source select
#define	TSc1Touch(x) _m1tss = x; //Reference Oscillator:0 OR  FSYS/4:1 Module 0

//Touch key module n Reference oscillator enable control
#define	ROc1Touch(x) _m1roen = x; // Disable:0 OR Enabled:1 Module 0

//Touch key module n Key oscillator enable control
#define	KOc1Touch(x) _m1koen = x; // Disable:0 OR Enabled:1 Module 0

//Touch key modules Keys enable control
#define	Module1ENTouch(w,x,y,z) _m1k4en = w; _m1k3en = x; _m1k2en = y; _m1k1en = z; // Module 0

//Touch key modules Keys enable control
#define	InKeyTouch1() _pcs01 = 1; _pcs00 = 0;
#define	InKeyTouch2() _pcs03 = 1; _pcs02 = 0;

//Multiplexer Key Select
#define KeyTouch1() _m1sk01 = 0; _m1sk00 = 0;	//key1
#define KeyTouch2() _m1sk01 = 0; _m1sk00 = 1;	//key2
...
{
	//KEY1
	if(Count_C1<Count_B1-50  && Count_C2>Count_B2-40){
		Count_T1++;
	...
	//KEY2
	if(Count_C2<Count_B2-50 && Count_C1>Count_B1-40){
		Count_T2++;
		if(Count_T2>100)Count_T2=100;
