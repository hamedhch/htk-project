...
#define S_SEG(A,B,C,D,E,F,G)_pb3=A;_pb2=B;_pb1=C;_pe1=D;_pb4=E;_pb7=F;_pb5=G;
#define COM(F,R,T,O,V) _pe4=O;_pe3=T;_pa0=R;_pa2=F;_pa6=V;
#define OUT()_pbc3=0;_pbc2=0;_pbc1=0;_pec1=0;_pbc4=0;_pbc7=0;_pbc5=0;_pec4=0;_pec3=0;_pac0=0;_pac2=0;  _pac6=0;_pac7=0;_pcc2=0;_pec0=0;_pcc3=0;_pac1=0;_pec2=0;_pac5=0;_pbc6=0;_pec5=1;_pepu5=1;
...
volatile unsigned char CNT_DISP=0,Disp=0,Seletion=1,Display=2,Hrs=17,Min=2,S=0,Temp=0,Sec=0;
...
volatile bit Bip,Lock,Dot,Seg1,Seg2,Seg3,Belinker,Belinking,PM1,PM2,SetTime,SetAlarm,Litgh,q1,q2;
...
void DispTimer(char Blk1, char Blk2)
{
    ...
    switch(Disp)
    {
		case 5:COM(0,0,0,0,0);if(Blk1==1){Displayer(H1);COM(1,0,0,0,0);}break;
		case 10:COM(0,0,0,0,0);if(Blk1==1){Displayer(H2);COM(0,1,0,0,0);}break;
	    case 15:COM(0,0,0,0,0);if(Blk2==1){Displayer(N1);COM(0,0,1,0,0);}break;
	    case 20:COM(0,0,0,0,0);if(Blk2==1){Displayer(N2);DOT=Dot;COM(0,0,0,1,0);}Disp=0;break;
...
{   
    ...
    switch(Disp)
    {
	    ...
	    case 15:COM(0,0,0,0,0);Cpin=0;Displayer(12);COM(0,0,0,1,0);Disp=0;break;
	    default: if(Litgh==1){COM(0,0,0,0,0);}break;
	}
}
