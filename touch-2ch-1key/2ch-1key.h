...
void Key_Touch()
{
	...
	if(Count_S1 < Count_C1 - 50)
	{
		...
		{
			if(function==0 ){
				if(out1==0 && out2==0)out1=1,Setinoff=1;
				if(out2==1)out2=0,out1=0;
			}
			
			if(function==1){
	 			if(out1==0 && out2==0)out1=1;
				else if (out1==1 && out2==0)out2=1;
				else if (out1==1 && out2==1)out1=0;
				else if (out1==0 && out2==1)out2=0;
 			}
		}
	...
	else if(Count_S1 > Count_C1 -10   )
	{
		...
		if(Count_T1 >= FINGER_FOCUS_ON  && Count_T1 <= FINGER_FOCUS_ON+300 && ch2change==0 && out1==1 && out2==0 && function==0 && Setinoff==0 && counterrgb!=600)
	 		{
	 			out1=0;
...
void __attribute((interrupt(0x04))) int0(void)
{
	...
	if(counterrgb==30)LED1=0;
	if(counterrgb==45)LED1=1;
